  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          "0%": { "box-shadow": "0 0 5px hsl(265, 89%, 78%), 0 0 10px hsl(265, 89%, 78%), 0 0 15px hsl(265, 89%, 78%)" },
          "100%": { "box-shadow": "0 0 10px hsl(265, 89%, 78%), 0 0 20px hsl(265, 89%, 78%), 0 0 30px hsl(265, 89%, 78%)" }
        },
        float: {
